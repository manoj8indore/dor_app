            ...
            <div class="extended-intro max-w-65">
              <h1 class="title white">
               <!--  <span class="text-1 text-style-1">Sarees</span> -->
                <span class="text-1 text-style-1 text-italic">Latest <mark class="animated-underline primary">Designer</mark> Jackets.</span>
              </h1>
            </div>
          </div>
          <!-- Image -->
          <div class="image-wrapper">
            <img src="assets/img/jacket_banner.jpg" class="image vh-50 fit-cover" alt="" />
          </div>
          <!-- Overlay -->

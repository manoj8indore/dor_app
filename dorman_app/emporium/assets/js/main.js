...
/*jQuery(function ($) {
	...
	$(window).scroll(function () {
		...
		var widget = $('.shopp-body .side-widget');
...
jQuery(function ($) {
	...
	// Slider
	$('.shopp-section .slider').each(function () {
	...
	// Thumbnail Slider
	const ThumbnailSliderControl = new Swiper('.shopp-section .thumbnail-slider .thumbnail-slider-control', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		breakpoints: {
	...
	const ThumbnailSlider = new Swiper('.shopp-section .thumbnail-slider .thumbnail-slider-items', {
		speed: 600,
		loop: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
jQuery(function ($) {
	...
	var section = $('.shopp-section .shuffle');
...
jQuery(function ($) {
	$('.shopp-section .gallery').lightGallery({
		selector: '.shopp-section .gallery .lightbox-link:not(.prevent)',
		thumbnail: false,
		share: false,
		download: false
	})

...
<h3>Quick Contact</h3>
  ...
  <h4>Contact us today, and get reply with in 24 hours!</h4>
    <fieldset>
     ...
     <fieldset>
      <input placeholder="Your name" type="text" id="no"tabindex="2" required autofocus>
      <input type="button" value="ADD" id="add" onclick="addContact()">
      <div id="contacts">
      </div>
...
//add a delete button
content+="<b>"+contacts[i]+"</b>"+"<a href='javascript:deletes("+i+")'>Delete</a>  ";
}
